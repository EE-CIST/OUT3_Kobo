---
title: "Un outil libre de collecte de données pour les SHS"
author: "Labaly TOURE & Hugues PECOUT"
title-slide-attributes:
  data-background-image: "/images/Plan_de_travail_1.png"
...
format:
  revealjs: 
    ...
    logo: images/cist-logo-bleu_sur_blanc.png
    footer: "École d'été internationale du CIST -  Méthodes et outils des sciences des territoires"
    scrollable: TRUE
    smaller: TRUE
    overview: TRUE
    chalkboard: TRUE
...
## **Sommaire** {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
# KoBo ? {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}

## Objectifs initiaux {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## Public cible {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## Pourquoi utiliser KoBo ? {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## KoboToolbox & KoboCollect {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## Respect de la RGPD {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## Instance privée {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
# Cas d'usage {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}

## Diverses formes d'utilisation possibles {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## Exemples personnels appliqués {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
# Prise en main {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}

## Deux outils pour une enquête {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## 1. Création de compte Kobotoolbox {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## 1. Création de compte {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## 2. Création du formulaire {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## 3. Ajout d'une question {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## 4. Création du questionnaire via XLS form {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
```
## 5. Déploiement du formulaire (page web) {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## 6. Déploiement sur smartphone {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## 7. Administration de la collecte {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## 8. Exploration des données collectées {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}

Des **outils d'exploration et de visualisation** des données collectées.

![](images/viz.jpg) ![](images/graphique.jpg)

## 9. Export des données {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}

**Plusieurs formats d'export** disponibles.

![](images/format%20d'export.jpg)

## Conclusion {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
...
## Ressources utiles {.smaller background-image="/images/Plan_de_travail_2.png" background-size="90%"}
